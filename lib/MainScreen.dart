...
class _HomePageState extends State<HomePage> {
  ...
  void _showNotification(String title, String body) async {
    var androidDetails = AndroidNotificationDetails(
        'channel_id', 'Local Notifications',
  ...
  void _checkReminders() {
    for (var reminder in reminders) {
      if (!reminder['notified'] && _isReminderToday(reminder['date'])) {
        _showNotification(reminder['title'],
            'This is your reminder for ${reminder['title']}');
        setState(() {
                  ...
                  child: Row(
                    children: [
                      featureBox(
                        context,
                        title: 'MedHub',
                        imagePath: 'assets/images/MedHub.png',
                        // Background image for MedHub
                        onTap: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                      ...
                      featureBox(
                        context,
                        title: 'MedReminder',
                        imagePath: 'assets/images/MedReminder.png',
                        // Background image for MedHub
                        onTap: () {
                          Navigator.push(
                            context,
  ...
  Widget featureBox(BuildContext context,
              ...
              Positioned.fill(
                child: Container(
                  color: Colors.teal.withOpacity(
                      0.3), // Slightly transparent black overlay
                ),
              ),
              // Title on top of the transparent rectangle
              Positioned(
                bottom: 0,
                left: 0,
                right: 0,
                child: Center(
                  child: Container(
                    ...
                    // Slightly transparent teal background
                    child: Center(
                      child: Padding(
